...
public class MailUtil {
    ...
    private String FROM_ADDRESS = "amsinfo6@gmail.com";
    private String PASSWORD = "meetravi123";
    private String FROM_NAME = "login credentials";

    public boolean sendMail(String[] recipients, String subject, String message) throws MessagingException {
        try {
